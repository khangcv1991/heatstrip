...
To use these stylesheets, rename the files and heatstrip with the name of your theme.
...
heatstrip-alpha-default-narrow.css  
...
heatstrip-alpha-default-normal.css
...
heatstrip-alpha-default-wide.css
