    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            $(document).ready(function () {
                ...
                $('#section-header').prepend('<div class="top-header"><ul><li id="kh_logo_left"><a href="#"><img src="http://localhost/heatstrip/sites/all/themes/custom/heatstrip/HeatstripLogo.png"/></a></li><li><a href="#"><img src="http://localhost/heatstrip/sites/all/themes/custom/heatstrip/HeatingWithStyle.png"/></a></li><li id="whitbox_background"><a href="#"><img src="http://localhost/heatstrip/sites/all/themes/custom/heatstrip/WhiteBox.png"/></a><span id="kh_right_logo_thermo"><img src="http://localhost/heatstrip/sites/all/themes/custom/heatstrip/ThermofilmLogo.png"/></span></li> </ul> <div id="kh_bg_20170405"> </div></div>')
