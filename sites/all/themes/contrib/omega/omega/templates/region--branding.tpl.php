  ...
  <div<?php print $content_attributes; ?>>
    ...
    <div class="branding-data clearfix">
      ...
      <div class="logo-img">
        ...
        <!-- Dung Hoang for mobile menu -->
        <a href="/" rel="home" title="" class="active mobile-menu"><img src="http://www.heatstrip.com.au/sites/default/files/logo-mobile.png" alt="" id="logo-mobile"></a>       
        <!-- Dung Hoang -->
      </div>
      <?php endif; ?>
